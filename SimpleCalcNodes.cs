...
namespace VisitorPattern_SimpleCalculator {
    ...
    public static class SimpleCalcExtensions {
        public static NodeType GetNodeType(this ASTNode node) { // extend ASTNode
            return (NodeType)node.MType;
        }
        public static void VisitNode(this AbstractParseTreeVisitor<int> visitor,
            ParserRuleContext parent,int context) { // extend AbstractParseTreeVisitor
        }
    }
    public class CompileUnit : ASTComposite {  
        ...
        public CompileUnit( ) : 
            base(1, (int)NodeType.NT_COMPILEUNIT, null) {   // constructor (generated), default parent null
        }
    }
    public class Addition : ASTComposite { 
        public const int LEFT = 0, RIGHT=1; // 2 context here , left and right
